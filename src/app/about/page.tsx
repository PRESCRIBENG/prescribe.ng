			...
			<div className="px-6 xl:px-[130px] py-12 space-y-16">
				<div className="items-center space-y-3">
					...
					<p className="text-[16px]">
						At PrescribeNG, we believe technology should close the gap between
						patients and the healthcare they need. Our platform connects
						individuals to licensed healthcare providers, offers secure software
						solutions to partners, and supports verified patients through
						carefully screened crowdfunding—ensuring access to quality care with
						integrity and trust.
						<br />
					</p>
				</div>
						...
						<div className="w-full md:w-[630px] md:flex-1 justify-between mt-6 md:mt-0">
							<div className=" flex  relative bg-white p-4 md:p-6 text-[#002A40]">
								...
								<p className=" text-[14px] sm:text-[16px]">
									At PrescribeNG, our mission is to bridge critical gaps in
									healthcare access through innovative technology and strategic
									partnerships. We connect patients with licensed healthcare
									providers including doctors, pharmacies, and hospitals, while
									offering end-to-end software solutions that strengthen
									healthcare delivery. For those facing life-threatening
									conditions and financial hardship, we support verified
									crowdfunding efforts rooted in thorough, multilayered
									investigations. Every campaign is genuine, every provider is
									vetted, and every donation goes where it’s truly needed
									because no one should be denied care due to circumstance.
								</p>
							</div>
						</div>
					</div>
