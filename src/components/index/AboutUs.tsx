				...
				<div className="flex-1 space-y-6 text-[#002A40] mt-6 sm:mt-0">
					<div className="space-y-[18px]">
						...
						<p className="text-[14px] sm:text-[16px]">
							At PrescribeNG, we bridge healthcare gaps with secure technology.
							Our platform connects verified providers to patients while
							offering partners cutting-edge software solutions. When lives are
							at risk, we enable trusted crowdfunding only after rigorous
							vetting. Together, we’re transforming care delivery through
